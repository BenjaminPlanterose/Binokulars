...
if [ "$1" == "-h" ] || [ "$1" == "--h" ] || [ "$1" == "--help" ] || [ "$1" == "-help" ]; then
  echo "Usage: $0 -t FILE -i FILE [-l INT -N INT -s CHAR -R INT -o CHAR -p INT -c INT]" >&2
  echo
...
# Parse arguments
while getopts ":t:i:l:N:R:o:c:" opt; do
  case $opt in
...
Rscript --vanilla $MY_PATH/binomL.R --target $target_file --epiread_chr_dir $input_dir --bin_length $bin_length --N_iter $N_iter --seed $SEED --output_dir $output_dir --nCores $nCores
